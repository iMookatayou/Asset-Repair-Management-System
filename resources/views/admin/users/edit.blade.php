  ...
  <div class="bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200">
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-5">
      <div class="flex items-start justify-between gap-4">
        ...
        {{-- Right: Back button (ใช้ maint-btn ให้เข้าชุด) --}}
...
{{-- ===========================
     Tom Select + Styling
     (ใช้ชุดเดียวกับหน้า Create User / Maintenance)
=========================== --}}
<link rel="stylesheet"
...
<style>
  ...
  /* เวลาใช้ ts-with-icon ให้ขยับข้อความเข้าไปหน่อย ไม่ให้ทับไอคอน */
  ...
  /* ===== ไอคอนแว่นขยายบนกล่องหลัก (อิงจาก Maintenance) ===== */
